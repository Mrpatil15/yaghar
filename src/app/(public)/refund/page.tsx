    ...
    <div className="min-h-screen bg-slate-50 py-12 px-4 sm:px-8 font-sans text-slate-900">
      <div className="max-w-3xl mx-auto bg-white p-8 sm:p-12 rounded-3xl border border-slate-200 shadow-sm space-y-6">
        ...
        <div className="space-y-4 text-xs text-slate-700 leading-relaxed">
          ...
          <p>
            YAGHAR offers a 14-day fully functional free trial without requiring credit card details upfront. You may evaluate the software and its features with zero financial obligation.
          </p>
          ...
          <p>
            If you encounter technical defects that prevent you from using the service, or if you were billed inadvertently within 7 days of subscription renewal without usage, you may request a refund by emailing <strong>billing@yaghar.in</strong>. Approved refunds will be processed back to the original payment source (UPI / NetBanking / Card) within 5 to 7 business days via Razorpay.
          </p>
        </div>
      </div>
    </div>
